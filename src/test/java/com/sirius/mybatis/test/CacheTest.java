...
public class CacheTest {
  ...
  public void firstLevelCacheTest() throws IOException {
    ...
    // 发起第一次查询，查询ID为1的用户
    User user1 = sqlSession.selectOne("com.sirius.mybatis.mapper.UserMapper.findByCondition", 1);
    ...
    // 发起第二次查询，查询ID为1的用户
    User user2 = sqlSession.selectOne("com.sirius.mybatis.mapper.UserMapper.findByCondition", 1);
